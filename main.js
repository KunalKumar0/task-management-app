        ...
        <div class="card shadow-sm task__card">
            ...
            <div class="card-body">
                ${
                    ...
                    :
                    `
                     <img width="100%" src="https://www.dpcanashik.com/uploads/default/blank.png" alt="card image cap" class="img-fluid place__holder__image mb-3">
                    `
                }
...
const saveEdit = (e) =>{
    ...
    ? {
        ...
        type: updateData.taskDescription,
        url: task.url,
    } 
    : task
    )
